...
var CONFIG = {
    ...
    indexHtmlTemplate: "./Client/index.html",
    fsharpEntry: "./Client/Client.fsproj",
    cssEntry: "./Client/style.sass",
...
module.exports = (env) => {
    ...
    var isProduction = env && env.prod;// !process.argv.find(v => v.indexOf('webpack-dev-server') !== -1);
    ...
    return {
        ...
        output: {
            path: env && env.publishDir ? env.publishDir : resolve(CONFIG.outputDir),
